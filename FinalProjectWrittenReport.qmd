...
I see that the shot that has the highest xG in the model is a lob by Lieke Martens against Vietnam that resulted in a goal. The shot has a xG of 0.8352. The video below displays the goal from the WWC 2023. The goal begins at 9:34 and ends at 9:38. Note that the video continues playing so you should stop it after the goal is done.
...
From the interactive shot map, I see that all of Alex Morgan's shots are from well inside the 18 yard box. Additionally, it is evident that she created two really great opportunities to score as both shots (colored pink) have a xG value of around 0.42. 
