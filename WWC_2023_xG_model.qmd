...
# figure out how to add shot result also to plot!!!
a5 = pitch + geom_point(data = shots_valid_wwc2023_no_corner, aes(x = location.x, y = location.y, color = my.xG$Goal, stroke = 2, alpha = 0.2)) + labs(color = "xG", caption = "Removed Republic of Ireland's goal directly from corner", title = "Expected Goals Model Women's World Cup 2023")
